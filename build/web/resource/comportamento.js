...
(function ()  {
    ...
    // A linha abaixo cria novo elemento
    var mobile = document.createElement('div');
    
    // Adiciona uma class ao novo elemento
    mobile.className = 'nav-mobile';
    
    // Coloca a nova tag no codigo fonte
	document.querySelector('.nav').appendChild(mobile);

	// Seleciona a nav-mobile do codigo fonte
	var mobileNav = document.querySelector('.nav-mobile');
    
    // Seleciona o nav-list
    var toogle = document.querySelector('.nav-list');

    mobileNav.onclick = function() {
    	apollo.toggleClass(mobileNav, 'nav-mobile-open');
    	apollo.toggleClass(toogle, 'nav-active');
    }
